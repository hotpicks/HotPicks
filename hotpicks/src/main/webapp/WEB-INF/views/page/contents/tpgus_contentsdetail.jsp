...
$(document).ready(function() {
	$('#hashTag').focus(function(){
		$('#hashTag').keyup(function(e){
			if(e.keyCode == 32){
				var hstg= "<label class='hs'>&nbsp;"+$('#hashTag').val()
				+"&nbsp;<a id='hscencel' href='#'><img class='x' src='${root}/resources/style/images/icon-x.png'></a></label>"
				$('.hsgroup').append(hstg);
				$('#hashTag').val('');
			}
		});
					...
					<div class="togglebox">
          				...
          				<form id="writeForm" name="writeForm" method="post" action="" enctype="multipart/form-data">
          					...
          					<div class="reviewInput">
          						...
          						<br>
          						<label style="font-size:15px;">해쉬태그:</label><span class="hsgroup"></span>
