...
<div id="wrapper"> 
  ...
  <div class="content">
    ...
    <h4>Heading 4</h4>
    <div class="one-sixth">
      <p>Nam laoreet rutrum ligula, at tincidunt ligula sagittis semper. Integer congue vehicula lectus eu. </p>
    </div>
    <div class="one-sixth">
      <p>Nam laoreet rutrum ligula, at tincidunt ligula sagittis semper. Integer congue vehicula lectus eu. </p>
    </div>
    ...
    <div class="one-third last">
      <p>Nam laoreet rutrum ligula, at tincidunt ligula sagittis semper. Integer congue vehicula lectus eu faucibus. Maecenas ante. </p>
    </div>
    <div class="clear"></div>
    <br />
    <h6>Heading 6</h6>
    ...
    <table cellspacing="0" cellpadding="0">
      <tr>
        ...
        <th class="center">Centered Header 3</th>
      </tr>
      <tr>
        <td>Division 1</td>
        <td>Division 2</td>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="price">
      ...
      <tr class="even">
        ...
        <td>&mdash;</td>
        <td>&mdash;</td>
        <td><img src="resources/style/images/check.png"/></td>
        <td><img src="resources/style/images/check.png"/></td>
      </tr>
      <tr>
        <td class="right">Lorem Ipsum</td>
