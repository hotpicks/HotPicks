    ...
    <div class="tab-wrapper">
      ...
      <div class="tab-content">
        ...
        <div class="tab">
          ...
          <div class="one-half">
            <div class="one-fifth"><img src="resources/style/images/icon1.png" /></div>
          ...
          <div class="one-half last">
            <div class="one-fifth"><img src="resources/style/images/icon2.png" /></div>
            <div class="three-fourth last">
              <h4>Illustration</h4>
              <p>Nulla ipsum nunc, gravida tempus varius eu, eleifend non elit. Nam elementum iaculis lorem, et viverra magna tempus vitae. Phasellus pharetra luctus felis. Nullam turpis ante, fermentum vitae fermentum vitae, tempus ut libero.</p>
            </div>
          ...
          <div class="one-half">
            <div class="one-fifth"><img src="resources/style/images/icon3.png" /></div>
            <div class="three-fourth last">
          ...
          <div class="one-half last">
            <div class="one-fifth"><img src="resources/style/images/icon4.png" /></div>
            <div class="three-fourth last">
              <h4>3D Design</h4>
              <p>Nulla ipsum nunc, gravida tempus varius eu, eleifend non elit. Nam elementum iaculis lorem, et viverra magna tempus vitae. Phasellus pharetra luctus felis. Nullam turpis ante, fermentum vitae fermentum vitae, tempus ut libero.</p>
            </div>
